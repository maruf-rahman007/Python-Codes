...
show_info = Ride_Sharing("Pathao")
show_info.add_rider("Turja")
show_info.add_rider("Rafim")
show_info.add_rider("Maruf")
show_info.add_driver("Abdul Karim")
show_info.add_driver("Kala Pasa")
print(show_info.riders)
print(show_info.drivers)